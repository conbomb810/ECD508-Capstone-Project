...
# This one pauses when coming across a target so you have time to manually load and shoot a BB. Press B when you're done (may need to do it twice) to resume normal operation
...
# flag for B button pressed
b_pressed = False

# flag for RB button pressed
rb_pressed = False
    ...
    while(i == 0):
        ...
        if state == 'A':
            ...
            if target_detected:
                ...
                print("Pausing for manual shooting. Press B to proceed")
            else:
...
class JoySubscriber(Node):
    ...
    def joyCallback(self, msg):
        ...
        global b_pressed, rb_pressed #, lb_pressed, turret_reset
